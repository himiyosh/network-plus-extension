...
- **設定はひとまとめ。** 🎛️ Settings ダイアログに言語・テーマ・保持数(Retention)を集約。説明文とガイドは日本語表示に対応(System / English / 日本語)し、ボタンなどの項目名は英語のままなので手順と画面が食い違いません。
