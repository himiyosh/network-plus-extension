...
| `docs/store-assets/chrome-small-promo-440x280.png` | 440 x 280 text-free brand tile: the extension icon with the sleeping otter and steaming cup beside it | No traffic data; fills the Edge Small promotional tile slot and the Chrome required small-promo slot |
