...
- GitHub release `v1.8.0` and `network-plus-extension-1.8.0.zip` were publicly observable and re-downloaded on 2026-08-18. The ZIP is 150672 bytes and its SHA-256 is `6dfd5cf599f6adf50ddf70103b48a5b9006655065e9887ec7a5c434e6a4c8623`. CI published the release from the release commit on `main`, and archive entries carry fixed timestamps, so `npm run extension:package` at tag `v1.8.0` rebuilds the same bytes.
...
| [Public v1.8.0 release](https://github.com/himiyosh/network-plus-extension/releases/tag/v1.8.0) | Released 2026-08-18 by the tag-triggered publishing workflow with one 150672-byte ZIP asset; SHA-256 re-verified from a fresh download | 2026-08-18 | Exact upload-artifact identity; not store-listing evidence |
