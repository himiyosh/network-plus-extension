...
- The mascot is now an otter, in the toolbar brand mark and the support dialog alike. Asleep it is the same quiet loaf — breathing, an occasional tail sway, a drifting z — but waking it now raises a magnifying glass, the investigator motif this network inspector deserves, alongside small dot eyes. The otter reads at the real 15-pixel size by the cues that survive it: round ears, a brown coat, a pale muzzle, and a thick tail. All motion still stops under `prefers-reduced-motion`.
